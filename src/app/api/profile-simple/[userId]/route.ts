...
export async function GET(
  ...
  try {
    ...
    // Fetch additional public profile data with simpler queries
    const [rankingsData, achievementsData, rareItemsData] = await Promise.all([
    ...
    const publicProfile = {
      ...
      completedCollections: [], // Simplified - empty for now
